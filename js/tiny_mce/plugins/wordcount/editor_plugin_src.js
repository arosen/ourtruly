...
(function() {
        ...
        init : function(ed, url) {
            ...
            t.recalc_keys = ed.getParam('wordcount_recalc_keys', [32,13,190,8,46]);
            t.block_ms = ed.getParam('wordcount_block_ms', 10);
            ...
            ed.onPostRender.add(function(ed, cm) {
                ...
                if (!id) {
                    ...
                    if (row) {
                        tinymce.DOM.add(row.parentNode, 'div', {'style': 'float: right; padding: 3px;'}, ed.getLang('wordcount.words', 'Words: ') + '<span id="' + t.id + '">0</span>');
                    }
                } else {
        ...
        _count : function(ed) {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {t.block = 0;}, t.block_ms);
            }, 1);
        },
